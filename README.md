...
## 🚀 Road Map
* Download the assests for data: [roboverse_data](https://huggingface.co/datasets/RoboVerseOrg/roboverse_data/tree/main)
* Check the trajectories for 5 RLBench tasks from RH20T and their success conditions.
* Use different robots to check for those conditions.
